...
describe('Page opening', function () {
    ...
    it('click registration button', function() {
        ...
        let back = browser.waitForVisible('button=< Back', 5000);
        assert.equal(back, true, 'Button is not clicked'); //compare that "title" variable equals to "Bug Tracker" and error-message if not
    })
    });